...
и преобразование чисел в слова (Silero не умеет озвучивать цифры).
"""
import torch
...
class SileroTTS:
    ...
    def speak(self, text: str):
        ...
        # Заменяем числа на числительные (Silero не умеет цифры)
        processed_text = preprocess_text(text)
        print(f"[SileroTTS] Текст для озвучивания: {processed_text[:100]}...")
